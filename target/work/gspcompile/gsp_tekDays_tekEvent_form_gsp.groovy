...
printHtmlPart(2)
invokeTag('datePicker','g',55,['name':("startDate"),'precision':("day"),'value':(tekEventInstance?.startDate)],-1)
printHtmlPart(3)
...
printHtmlPart(2)
invokeTag('datePicker','g',64,['name':("endDate"),'precision':("day"),'value':(tekEventInstance?.endDate)],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1411713325908L
