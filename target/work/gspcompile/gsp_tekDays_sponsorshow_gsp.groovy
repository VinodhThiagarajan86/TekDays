...
printHtmlPart(17)
if(true && (sponsorInstance?.sponsorships)) {
printHtmlPart(23)
invokeTag('message','g',62,['code':("sponsor.sponsorships.label"),'default':("Sponsorships")],-1)
printHtmlPart(24)
...
invokeTag('link','g',74,['class':("edit"),'action':("edit"),'resource':(sponsorInstance)],3)
printHtmlPart(30)
...
invokeTag('form','g',77,['url':([resource:sponsorInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1411709581164L
